...
def set_model():
    model = ResNet18(num_classes=10*2).cuda()
    criterion = DILoss(num_classes=10, num_biases=2)
...
def main():
    ...
    exp_name = f'di-cifar10-{opt.exp_name}-lr{opt.lr}-bs{opt.bs}-seed{opt.seed}'
